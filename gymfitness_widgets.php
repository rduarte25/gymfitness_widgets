...
* Plugin URI:
* Description: Añade Widgets personalizados al sitio gymfitness.
* Version: 0.0.1
...
function register_gymfitness_clases_widget() {
    register_widget( 'GymFitness_Clases_Widget' );
}
add_action( 'widgets_init', 'register_gymfitness_clases_widget' );
